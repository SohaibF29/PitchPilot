...
- **Executive Summary**: High-level summary of the startup concept, key value proposition, and elevator pitch.
- **Boardroom Agenda**: Agenda points and specific focus areas you want the other board members (Market Analyst, PM, Finance, Tech) to evaluate.
- **Initial Score**: Scale of 1-10. Be BRUTAL and extremely strict. 1-4: Fundamental flaws, no viability. 5-7: High risk, major unproven assumptions. 8-10: Exceptional clarity, traction, and realism. Do NOT give scores above 6 unless the pitch is truly exceptional.
